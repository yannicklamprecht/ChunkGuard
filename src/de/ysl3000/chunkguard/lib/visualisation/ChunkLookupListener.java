    ...
    public void playAtChunk(final Optional<Player> p, final Chunk chunk, final Play play) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously((Plugin)this.plugin, (Runnable)new Runnable() {
            ...
            public void run() {
                ...
                // 
                //     0: aload_0         /* this */
                //     1: getfield        de/ysl3000/chunkguard/lib/visualisation/ChunkLookupListener$1.val$p:Ljava/util/Optional;
                ...
                //    18: aload_1         /* manager */
                //    19: aload_0         /* this */
                //    20: getfield        de/ysl3000/chunkguard/lib/visualisation/ChunkLookupListener$1.val$chunk:Lorg/bukkit/Chunk;
                //    23: iconst_1       
                //    24: anewarray       Lde/ysl3000/chunkguard/lib/visualisation/locationmanagement/ILocationValidator;
                //    27: dup            
                //    28: iconst_0       
                //    29: new             Lde/ysl3000/chunkguard/lib/visualisation/locationmanagement/BorderValidator;
                //    32: dup            
                //    33: invokespecial   de/ysl3000/chunkguard/lib/visualisation/locationmanagement/BorderValidator.<init>:()V
                //    36: aastore        
                ...
                //    59: aload_0         /* this */
                //    60: aload_0         /* this */
                //    61: getfield        de/ysl3000/chunkguard/lib/visualisation/ChunkLookupListener$1.val$p:Ljava/util/Optional;
                //    64: aload_0         /* this */
                //    65: getfield        de/ysl3000/chunkguard/lib/visualisation/ChunkLookupListener$1.val$play:Lde/ysl3000/chunkguard/lib/visualisation/ChunkLookup$Play;
                //    68: invokedynamic   accept:(Lde/ysl3000/chunkguard/lib/visualisation/ChunkLookupListener$1;Ljava/util/Optional;Lde/ysl3000/chunkguard/lib/visualisation/ChunkLookup$Play;)Ljava/util/function/Consumer;
                ...
                //  0      79      0     this     Lde/ysl3000/chunkguard/lib/visualisation/ChunkLookupListener$1;
